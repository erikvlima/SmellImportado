<%-- 
    Document   : listaAutor
    Created on : 16/08/2016, 09:47:58
    Author     : erik
--%>
...
<html>
    <head>
        ...
        <title>SisLivros - Sistema de gereciamento de livros - Listagem de Autores - 0.1.0 Beta</title>
    </head>
    <body>
       <h1>Seja Bem-Vindo ao SisLivros 0.1.0 - Beta - Listagem de Autores</h1>
        <div style="padding:10px; background-color: #cccccc; text-align: center;">
            ...
            <span style="padding: 5px">
            <a href="publicacoes.jsp" title="Clique para listar as publicações">Listagem de Publicações</a>
            </span>
        </div>
