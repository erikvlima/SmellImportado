                            ...
                            <div class="row">
                                <div class="row"> 
                                    ...
                                    <fieldset class="col-lg-2 alinhado-direita top-right" >
                                        ...
                                        <a href="produtos?cmd=categoria&cat=m" ><button class="btn alinhado-direita">Masculino</button></a><br>
                                        <br><a href="produtos?cmd=categoria&cat=f" ><button class="btn alinhado-direita">Feminino</button></a>   
                                    </fieldset>
